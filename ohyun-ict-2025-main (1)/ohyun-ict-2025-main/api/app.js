//https://github.com/wonbeomcho/ohyun-ict-2025
//선생님 깃허브

const post_url = "http://crud.tlol.me/bborock/post";
let pagePointer = 0;
let currentPostId = null;
let currentPage = 1;
const pageSize = 5;
//post데이터를 받아서 modal에 내용을 추가하고 show클래스를 추가해 화면에 띄우는 함수ㅠ
...
//모달 취소하기 버튼을 누르면 모달을 숨기고 현재 포스트 id 지우기
